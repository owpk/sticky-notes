...
export const NoteEditor: FunctionComponent<NoteEditorProps> = (noteEditorProps: NoteEditorProps) => {
    ...
    const handleChange = (e: EditorState) => {
        changeEditorState(e);
        noteEditorProps.changeTextCallback?.(
    ...
    const onTabHandling = (e: React.KeyboardEvent<{}>) => {
        ...
        changeEditorState(EditorState.push(
            currentState, newContentState, 'insert-characters'))
    }
